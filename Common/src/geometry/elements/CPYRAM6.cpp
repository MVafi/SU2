...
CPYRAM6::CPYRAM6() : CElementWithKnownSizes<NGAUSS,NNODE,NDIM>() {
  ...
  /*--- Gauss coordinates and weights ---*/
   ...
   GaussCoord[0][0] = sqrt(4.0/27.0);  GaussCoord[0][1] = sqrt(4.0/27.0);  GaussCoord[0][2] = 1.0/6.0;  GaussWeight(1) = 9.0/20.0;
   GaussCoord[0][0] = sqrt(4.0/27.0);  GaussCoord[0][1] = sqrt(4.0/27.0);  GaussCoord[0][2] = 1.0/6.0;  GaussWeight(2) = 9.0/20.0;
   GaussCoord[0][0] = sqrt(4.0/27.0);  GaussCoord[0][1] = sqrt(4.0/27.0);  GaussCoord[0][2] = 1.0/6.0;  GaussWeight(3) = 9.0/20.0;
